...
`client.api_url` in [`config.toml`](#configuration) >
`http://localhost:7812`. Persist a non-default URL once with
`keryx auth set <key> --api-url http://myhost:7812`, or edit the file.
